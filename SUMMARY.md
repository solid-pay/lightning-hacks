...
* [Lightning Mainnet in 60 seconds](quick-hacks/lightning-mainnet-in-60-seconds.md)
* [Fun Micro Services](quick-hacks/fun-micro-services.md)
* [Social Network Integration](quick-hacks/social-network-integration.md)

## CHAPTER 2 - HOST YOUR OWN NODE

* [Hosting a node on a raspberry Pi](chapter-2-host-your-own-node/hosting-a-node-on-a-raspberry-pi.md)
